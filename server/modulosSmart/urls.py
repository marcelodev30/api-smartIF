...
urlpatterns = [
    ...
    path('api/usuarios/<int:pk>/', UsuárioDetalhes.as_view(), name='usuario-detalhes'),
    path('api/usuarios/nivel-acesso/<uuid:idKey>/', UsuárioNívelAcesso.as_view(), name='user_nivel'),
